...
phase: inception
execution: ALWAYS
condition: Always executes — determines which stages to execute, their depth, and the execution sequence; user can override recommendations
...
consumes:
  ...
  - artifact: inception/user-stories/stories.md
    required: false
  - artifact: inception/user-stories/personas.md
    required: false
...
<!-- BEGIN GENERATED: execution-plan-mermaid | do not hand-edit — regenerated by scripts/generate.py from stage frontmatter (see references/common/stage-contract.md) -->
```mermaid
flowchart TD
    Start(["User Request"])
    ...
    subgraph INCEPTION["🔵 INCEPTION PHASE"]
        ...
        ApplicationDesign["Application Design<br/><b>STATUS</b>"]
        UnitsGeneration["Units Generation<br/><b>STATUS</b>"]
    end
    
    subgraph CONSTRUCTION["🟢 CONSTRUCTION PHASE"]
        FunctionalDesign["Functional Design<br/><b>STATUS</b>"]
        NfrRequirements["NFR Requirements<br/><b>STATUS</b>"]
        NfrDesign["NFR Design<br/><b>STATUS</b>"]
        InfrastructureDesign["Infrastructure Design<br/><b>STATUS</b>"]
        CodeGeneration["Code Generation<br/><b>STATUS</b>"]
        BuildAndTest["Build and Test<br/><b>STATUS</b>"]
    end
...
```
<!-- END GENERATED: execution-plan-mermaid -->

**Note**: Replace STATUS placeholders with actual phase status (COMPLETED/SKIP/EXECUTE) and apply appropriate styling

## Phases to Execute

<!-- BEGIN GENERATED: execution-plan-stages | do not hand-edit — regenerated by scripts/generate.py from stage frontmatter (see references/common/stage-contract.md) -->
### 🔵 INCEPTION PHASE
...
### 🟢 CONSTRUCTION PHASE
- [ ] Functional Design - [EXECUTE/SKIP] (per-unit)
  - **Rationale**: [Why executing or skipping]
- [ ] NFR Requirements - [EXECUTE/SKIP] (per-unit)
  - **Rationale**: [Why executing or skipping]
- [ ] NFR Design - [EXECUTE/SKIP] (per-unit)
  - **Rationale**: [Why executing or skipping]
- [ ] Infrastructure Design - [EXECUTE/SKIP] (per-unit)
  - **Rationale**: [Why executing or skipping]
...
<!-- END GENERATED: execution-plan-stages -->
...
<!-- BEGIN GENERATED: state-template-stages | do not hand-edit — regenerated by scripts/generate.py from stage frontmatter (see references/common/stage-contract.md) -->
### 🔵 INCEPTION PHASE
- [ ] Workspace Detection
...
### 🟢 CONSTRUCTION PHASE
- [ ] Functional Design (per-unit, if applicable)
- [ ] NFR Requirements (per-unit, if applicable)
- [ ] NFR Design (per-unit, if applicable)
- [ ] Infrastructure Design (per-unit, if applicable)
- [ ] Code Generation (per-unit)
- [ ] Build and Test

### 🟡 OPERATIONS PHASE
- [ ] Operations - PLACEHOLDER
<!-- END GENERATED: state-template-stages -->
