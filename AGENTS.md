...
- 引擎测试与生成器测试同套件（`scripts/tests/`，共 77 例）：改引擎后必跑 `python -m unittest discover -s .agents\skills\aidlc-workflows\scripts\tests`。
